...
if (process.env.NODE_ENV !== 'production') {
    module.exports = function $$$reconciler($$$hostConfig) {
        ...
        function retrySuspenseComponentWithoutHydrating(current$$1, workInProgress, renderExpirationTime) {
            ...
            (function() {
                if (!(returnFiber !== null)) {
                    {
                        throw ReactError(
                            Error('Suspense boundaries are never on the root. This is probably a bug in React.')
                        );
                    }
                }
            })();
                        ...
                        (function() {
                            {
                                {
                                    throw ReactError(
                                        Error('Pinged unknown suspense boundary type. This is probably a bug in React.')
                                    );
                                }
                            }
                        })();
        ...
        function warnIfNotScopedWithMatchingAct(fiber) {
            {
                if (
                    ...
                    warningWithoutStack$1(false, '', getStackByFiberInDevAndProd(fiber));
                }
            }
        }
        ...
        function checkForWrongSuspensePriorityInDEV(sourceFiber) {
            {
                ...
                if (
                    ...
                    (currentPriorityLevel === UserBlockingPriority || currentPriorityLevel === ImmediatePriority)
                ) {
        ...
        // `react-reconciler/inline.<renderer>` (which is *not* Flow typed) to
